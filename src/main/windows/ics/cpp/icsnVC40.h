...
typedef struct __declspec(align(2))
{
    ...
    unsigned short  can_switch_mode;
    STextAPISettings text_api;
    unsigned short  termination_enables;
    LIN_SETTINGS    lin6;
    ETHERNET_SETTINGS ethernet;
    unsigned short  slaveVnetA;
    unsigned short  slaveVnetB;
    unsigned short  flags; //1 disableUsbCheckOnBoot
}   SFIRE2Settings;
...
typedef struct __declspec(align(2))
{
	...
	unsigned short network_enables;
	unsigned short network_enables_2;  
	unsigned short network_enabled_on_boot;  //Mark
